...
@RestController
@RequestMapping(value = "/api/withdrawals", consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
...
public class WithdrawalController {
    ...
    @Operation(summary = "Withdraw money from account", description = "Creates debit transaction")
    @ApiResponses(value = {
    ...
    public ResponseEntity<UUID> withdraw(
            Principal principal,
        ...
        UUID transactionId = bankOperationService.withdraw(caller, account, amountDTO.amount());
